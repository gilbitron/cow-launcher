...
.defines(function(){ "use strict";
	...
	ig.Button = ig.Class.extend({
		...
		mouseDown: function( ev ) {
			...
			if( this.checkStart(ev.timeStamp, ev.clientX - pos.left, ev.clientY - pos.top) ) {
				return;
			}
		},
	...
	ig.ButtonCollection = ig.Class.extend({
		buttons: [],
